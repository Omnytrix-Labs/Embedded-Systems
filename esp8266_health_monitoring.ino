...
const char* ssid = "Omnytrix labs";  // Enter SSID here
const char* password = "Omnytrix@123";  //Enter Password here
...
html += ".header h1 { padding-bottom: 0.3em; color: #b08080; font-size: 45px; font-weight: bold; font-family: Garmond, 'sans-serif'; text-align: center;}";
html += "h2 { padding-bottom: 0.2em; border-bottom: 1px solid #eee; margin: 2px; text-align: left;}";
html += ".header h3 { font-weight: bold; font-family: Arial, 'sans-serif'; font-size: 17px; color: #a6b6b6; text-align: center;}";
...
html += "<div class='sensors'>";
html += "<p class='sensor'>";
html += "<i class='fas fa-tint' style='color:#bbbbbb'></i>";
html += "<span class='sensor-labels'> Humidity Inside... </span>";
html += (int)humidity;
...
//For Heart Rate
html += "<p class='sensor'>";
html += "<i class='fas fa-heart' style='color:#cb2300'></i>";
html += "<span class='sensor-labels'> Heart beat........ </span>";
html += (int)BPM;
...
//For Sp02
html += "<p class='sensor'>";
html += "<i class='fas fa-wind' style='color:#f7347a'></i>";
html += "<span class='sensor-labels'> Oxygen Level...... </span>";
html += (int)SpO2;
html += "<sup class='units'>%</sup>";
html += "</p>";
html += "<hr>";
...
html += "<p class='sensor'>";
html += "<i class='fas fa-thermometer-full' style='color:#a9534f'></i>";
